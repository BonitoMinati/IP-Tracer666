...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mTool Name \033[01;37m:- \033[01;36mIP-Tracer666
         \033[01;33mAuthor \033[01;37m:- \033[01;36mMr.Minati
         \033[01;33mPowered By \033[01;37m:- \033[01;36mBonitoMinati
...
EOL;
  $getact = readline('  IP-Tracer666 >> ');
  menu();
}

function upd() {
  logo();
  echo "\n\033[01;32mUpdating IP-Tracer666.........\033[01;37m\n\n";
  sleep(1);
  system("cd ~/ && git clone https://github.com/BonitoMinati/IP-Tracer666.git");
  system("cd ~/ && sudo git clone https://github.com/BonitoMinati/IP-Tracer666.git");
  system("cd ~/IP-Tracer666 && sh install");
  logo();
